...
def aggregate(before_aggregate, aggregate_feature):
    print('aggregate feature: '+ str(aggregate_feature))
    after_aggregate = []
    if aggregate_feature == 'day':
        ...
        for i, item in temp:  # i is group id
            ...
            #print('group_unit: ' + str(group_unit))
            # after_aggregate.append(group_unit)
            # for feature_i in range(6):
            #     mean.append(list(zip(group_unit))[feature_i])
...
# todo visualization task

# todo imbalance task

# todo black box classification task

# todo white box classification task
...
for i in range(len(y_predict)):
    ...
    if y_test[i] == 0 and y_predict[i] == 0:
        TN += 1
print('TP, True Positive: '+ str(TP))
print('FP, False Positive: '+ str(FP))
print('FN, False Negative: '+ str(FN))
print('TN, True Negative: '+ str(TN))
# print confusion_matrix(y_test, answer) watch out the element in confusion matrix
